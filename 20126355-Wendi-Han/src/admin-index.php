<!-- this file same as manager-index.php, include the statistics of reps,
the different is admin can see all the reps -->
<!DOCTYPE html>
<html>
<?php session_start();
...
$sql = "SELECT repsName From ordering WHERE ordering.status = 0 GROUP BY repsName ORDER BY sumprice DESC";
