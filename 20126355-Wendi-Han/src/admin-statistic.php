<!-- this is a complete statistic for admin include total statistic, processing statistic, finished statistic
    , statistics by time, statistics by region, statistics by customer, also, can modify the price in this page -->
<!DOCTYPE html>
<html>
<?php session_start();
...
$sql = "SELECT COUNT(customerName) as customerNumber FROM ordering WHERE status = 0";
